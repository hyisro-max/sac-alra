...
```bash
cd sacai-platform
less ARCHITECTURE_DECISIONS.md
```

Search the document for every mandate section and confirm no implementation is
classified as executable Knowledge. This stage changes no running service.
